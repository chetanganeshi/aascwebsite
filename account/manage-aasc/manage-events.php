...
<script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-events-update-modal.php?id='+id); /*Modal Content Load from page location*/
    ...
    <form method="post" action="manage-events.php">
      <table class="table table-bordered">
        <tr>
          ...
          <th colspan="4" class="panel-heading" style="font-weight: bold; text-align: center;"> events </th>
        </tr>   
        <tr>
        ...
        <tr>
          <td><span style="color: #3973ac; font-weight: bold; ">Name</td>
          <td><input type="text" name="txtname" id="txtname" class="form-control" style="width: 200px"></td>
        </tr>

        <tr>
          <td><span style="color: #3973ac; font-weight: bold; ">Timings</td>
          <td><input type="phone" name="txttimings" id="txttimings" class="form-control" style="width: 200px"></td>
        </tr>
        
        <tr>
          <td><span style="color: #3973ac; font-weight: bold; ">Info</td>
          <td><input type="phone" name="txtinfo" id="txtinfo" class="form-control" style="width: 200px"></td>
        </tr>
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'manage-events-delete-code.php',
               data: ({ id: id }),
  ...
  else
  {
    $.ajax({
         ...
         
     {
             if(response3 == "1")
            {  
              $('.modal-body').html(" Event Added Successfully");
                 $("#myModal").modal();   
                  setTimeout(function(){
                  window.location.href='manage-events.php';
                  }, 1000); 
             ...
             {
                 $('.modal-body').html("Event Not Added");
                 $("#myModal").modal();
             }
         }
      });
