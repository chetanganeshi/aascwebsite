...
<head>
  ...
  <script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-faq-update-modal.php?id='+id); /*Modal Content Load from page location*/
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <form method="post" action="manage-faq.php">
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td><span style="color: #3973ac; font-weight: bold; ">Question</span></td>
          <td><input type="text" name="title1" id="title1" class="form-control" >
          </td>
          </tr>
          <tr>
          <td><span style="color: #3973ac; font-weight: bold; ">Answer</span></td>
...
function delete_row(id)
{
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'manage-faq-delete-code.php',
               data: ({ id: id }),
  ...
  $(document).ready(function() {  
    ...
    if(title1=='') 
    {
      infoAlert("Please Enter Question");
    }
    
    if(detail=='')
    {
       infoAlert("Please Enter Answer");
    }
  else
  {
    $.ajax({
