  ...
  $imginp = $_FILES['img']['name'];
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["img"]["tmp_name"], $target_file)) {
          ...
          $query = mysqli_query($conn, "INSERT INTO imgs (id,img) VALUES ('$cid','$imginp')");
...
<head>
  ...
  <?php include '../../assets/dashboard-assets-css.php'; ?>
   <script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-gallery-update-modal.php?id='+id); /*Modal Content Load from page location*/
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <form method="post" action="manage-gallery.php"  name="myForm" id="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td><span style="color: #3973ac; font-weight: bold; "> Add Image to Gallery</span></td>
...
?>      
        <div id="tbl_row">
          <tr>
            <td><?php echo $id; ?></td>
            <td><img src="galleryimages/<?php echo $imagename; ?>" width="100" height="100" alt="gallery image"></td>
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'manage-gallery-delete-code.php',
               data: ({ id: id }),
...
function validateForm() 
  {  
    var imginp = document.forms["myForm"]["img"].value;
        ...
        if (imginp== "") {
        infoAlert("Please Upload Your Image");
        return false;
    }
}
</script>
