...
<script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-address-update-modal.php?id='+id); /*Modal Content Load from page location*/
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <form method="post" action="manage-address.php">
      <table class="table table-bordered">
        ...
        <tr>
          <td><span style="color: #3973ac; font-weight: bold; "> Address</td>
...
function delete_row(id)
{
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'manage-address-delete-code.php',
               data: ({ id: id }),
  ...
  $(document).ready(function() {  
    ...
    if(adrs=='') 
    {
      infoAlert("Please Enter Address");
      
    }
        if(cont=='') 
    {
      infoAlert("Please Enter Contact No");
      
    }
        if(email=='') 
    {
      infoAlert("Please Enter Email ");      
    }
