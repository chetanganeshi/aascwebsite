...
<script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-enquiry-query-send-reply.php?id='+id); /*Modal Content Load from page location*/
...
<div class="modal-dialog">
  <div class="modal-content" style="border-radius: 0px;">
    ...
    <br>
                <form id="modalform" name="modalform" action="manage-enquiry-query-send-reply.php" class="form-horizontal calender" method="POST">
 ...
 $(document).ready(function(){
  ...
  $('#update').click(function(event) {
    ...
    else
    {
        $.ajax({
            type: 'POST',
            url: 'manage-enquiry-query-update-code.php',
            data: ({ id: id, name2:name2, emailid2: emailid2, subject2:subject2, reply2:reply2}),
