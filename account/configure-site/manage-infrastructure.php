...
<script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-infrastructure-update-modal.php?id='+id); /*Modal Content Load from page location*/
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <form method="post" action="manage-infrastructure.php">
      <table class="table table-bordered">
        <tr>
        
          <th colspan="4" class="panel-heading" style="font-weight: bold; text-align: center;"> About </th>
        </tr>   
        <tr>
        ...
        <?php
                                     ...
                                     $result = mysqli_query($conn,"SELECT MAX(id)+1 FROM infrastructure");
...
<?php
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM infrastructure");
...
function delete_row(id)
{
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'manage-infrastructure-delete-code.php',
               data: ({ id: id }),
               ...
               if(response == "1" || response == 1 )
               {
                 ...
                 setTimeout(function(){
                   window.location.href='manage-infrastructure.php';
                 }, 1000);
               }
               else
               {
  ...
  else
  {
    $.ajax({
         type: 'POST',
         url: 'manage-infrastructure2.php',
         ...
         
     {
             if(response3 == "1")
            {  
              $('.modal-body').html(" Infrastructure Added Successfully");
                 $("#myModal").modal();   
                  setTimeout(function(){
                  window.location.href='manage-infrastructure.php';
                  }, 1000); 
             ...
             {
                 $('.modal-body').html("Infrastructure Not Added");
                 $("#myModal").modal();
             }
         }
      });
