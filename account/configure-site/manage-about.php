...
<script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-about-update-modal.php?id='+id); /*Modal Content Load from page location*/
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #ffffff; ">
    ...
    <form method="post" action="manage-about.php">
      <table class="table table-bordered">
        ...
        <?php
                                     ...
                                     $result = mysqli_query($conn,"SELECT MAX(id)+1 FROM about");
        ...
        <tr>
          <td><span style="color: #3973ac; font-weight: bold; ">About</td>
...
<?php
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM about");
      ...
      $.confirm({
        ...
        buttons: {
            confirm: function () {
               ...
               $.ajax({
               type: 'POST',
               url: 'manage-about-delete-code.php',
               data: ({ id: id }),
  ...
  else
  {
    $.ajax({
         ...
         
     {
             if(response3 == "1")
            {  
              $('.modal-body').html(" About Added Successfully");
                 $("#myModal").modal();   
                  setTimeout(function(){
                  window.location.href='manage-about.php';
                  }, 1000); 
             ...
             {
                 $('.modal-body').html("About Not Added");
                 $("#myModal").modal();
             }
         }
      });
