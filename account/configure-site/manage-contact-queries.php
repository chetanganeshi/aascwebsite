...
<head>
  ...
  <script type="text/javascript">
      ...
      {
        setTimeout(function(){
          $('#light_box').load('manage-contact-queries-update-modal.php?id='+id); /*Modal Content Load from page location*/
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="background-color: #ffffff; ">
      ...
      <section class="content-header">
			<center> <h4>Manage Contact Queries</h4> </center>
      </section>
    ...
    $.confirm({
      ...
      buttons: {
        confirm: function () {
         ...
         $.ajax({
           type: 'POST',
           url: 'manage-contact-queries-delete-code.php',
           data: ({ id: id }),
