  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="background-color: #ffffff; ">
      ...
      <section class="content-header">
		<center><h4>Approved Users</h4></center>
      </section>
        ...
        <div class = "table-responsive">
          <table id="example" class="table table-striped table-bordered cell-border" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              $get2 = mysqli_query($conn,"SELECT * FROM approvedusers");
              while($row2 = mysqli_fetch_array($get2))
              {
                ...
                <div id="tbl_row">
                  <tr>
                    ...
                    <td>
                      <!--<input type="button" name="btnApprove" id="btnApprove" value="Approve" class="btn btn-success" onclick="approve_row('<?php echo $uid; ?>')">-->
    ...
    $.confirm({
      ...
      buttons: {
        confirm: function () {
         ...
         $.ajax({
           type: 'POST',
           url: 'manage-approved-users-delete-code.php',
           data: ({ uid: uid }),
           success: function(response) {
             ...
             if(response == "1" || response == 1 )
             {
               ...
               setTimeout(function(){
                 window.location.href='manage-approved-users.php';
               }, 1000);
             }
             else
             {
